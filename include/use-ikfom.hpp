...
struct state_ikfom
{
	Eigen::Vector3d pos = Eigen::Vector3d(0,0,0);                         //* 位姿x
	Sophus::SO3 rot = Sophus::SO3(Eigen::Matrix3d::Identity());			  //* 旋转
	Sophus::SO3 offset_R_L_I = Sophus::SO3(Eigen::Matrix3d::Identity());  //* 旋转外参
	Eigen::Vector3d offset_T_L_I = Eigen::Vector3d(0,0,0);				  //* 平移外参
...
//对应公式(7)的Fx  注意该矩阵没乘dt，没加单位阵  对应公式(7)
